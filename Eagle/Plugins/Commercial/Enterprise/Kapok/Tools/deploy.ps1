...
# PowerShell Web Application Script
#
...
if (($path -eq $null) -or ($path -eq "")) {
  Write-Error "The physical path is required."
  Break
}

Import-Module WebAdministration

New-WebApplication -Name kapok -Site "Default Web Site" `
    -PhysicalPath $path -ApplicationPool "Classic .NET AppPool"

#
# New-WebApplication -Name kapok -Site "Default Web Site" `
#     -PhysicalPath $path -ApplicationPool "ASP.NET v4.0 Classic"
#

# SIG # Begin signature block
# MIIiwwYJKoZIhvcNAQcCoIIitDCCIrACAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCc9eS8jyO5tQ9X
# vdiAo1t6uK0mZwhS3fjr9+J9JjXCdaCCHdMwggPFMIICraADAgECAhACrFwmagtA
...
# IPyT/wesLeuxiyURtTSuzQejR0fDMSS0it4Q4udqLRsLMA0GCSqGSIb3DQEBAQUA
# BIIBAAf3hLDiPTTXEa/7s4tCGdibLoPMT2DpODOB75wArI+S2GRgA2D6WXQkMIhP
# zGVzztNz4rZDSUorteB9Xxfbmf74fkG33XActIgzSiaeU60cfnPkmH4vh558xAzn
# CRwgeKw1gYxN/ELtLgKCFq0hn0ptn9gaI7Fc1J614Yu/DlF+OdeG47Vnnd0/H3nb
# 1jAkRwpxwaStAw+8DvtbzwmG0xOGxEt/aMWVnnfeDeMzNokq2REANN7RU726YY8s
# 2w7WUjqBeisf2eTyDpwUxXs4gbqqD0J0vQDHuLUiCgasrk90tZ/8x4D7uj14nVxO
# awPqb9iynVqn/SdtMlz9zU6ZUnqhggIPMIICCwYJKoZIhvcNAQkGMYIB/DCCAfgC
...
# DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE2MDQwNjA1MDQwN1ow
# IwYJKoZIhvcNAQkEMRYEFA74evuA68NO4Zcmr+2i4tBFl66LMA0GCSqGSIb3DQEB
# AQUABIIBAJlPGa9ozfSvxgnHfQeWe6SQQFdnM6syLsizonSq+BvIz89Vtwqmdxdr
# vWtAsw5B2xI2kodynShK16EQQW5WgQWERNIVubDgokRTxLwtmONSPXS2hXWe+ab/
# in2kb6gTKm/JmVLppplUer7Qp1oXgSB5F57dnHR0x1pNX1kX9P6xRk8tnaY0sjeR
# awfpo6sAQpziscj5rniw6rMFseODFkioWYOdHq/7hiMIgWyeAZJ2b8+4M/KkCaGk
# lKAT9GgJ/CJFmK00AIXQ/qhQSSJdBr4Nhk65Agclls+agl+KET4NzotyjjN+6f29
# KyFW97hkUD1DxhU+bAr/YrE1oKWM3Pg=
